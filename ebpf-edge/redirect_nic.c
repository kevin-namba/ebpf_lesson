...
int xdp_redirect_to_right(struct xdp_md *ctx)
{
	...
	unsigned ifindex = 25/* TODO: put your values here */;
...
int xdp_redirect_to_left(struct xdp_md *ctx)
{
	void *data_end = (void *)(long)ctx->data_end;
	void *data = (void *)(long)ctx->data;
	struct hdr_cursor nh;
